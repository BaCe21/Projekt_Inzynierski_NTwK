namespace TrikProjekt56.Controllers
{
    ...
    public class EducationController : Controller
    {
        ...
        public IActionResult Index(string sortExpression = "", string SearchText = "", int pageIndex = 1, int pageSize = 5)
        {
            ...
            Pagination<Education> items = _repo.GetItems(sortModel.SortedProperty, sortModel.SortedOrder, SearchText, pageIndex, pageSize);
        ...
        private readonly IEducation _repo;
        ...
        {
            Education item = _repo.GetItem(id);
            TempData.Keep();
            return View(item);
        }
        ...
        [HttpPost]
        public IActionResult Edit(Education item)
        {
            bool myBool = false;
            string errMessage = "";
            try
        ...
        [HttpPost]
        public IActionResult Delete(Education item)
        {
            try
            {
