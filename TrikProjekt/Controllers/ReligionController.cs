namespace TrikProjekt56.Controllers
{
    ...
    public class ReligionController : Controller
    {
        ...
        public IActionResult Index(string sortExpression = "", string SearchText = "", int pageIndex = 1, int pageSize = 5)
        {
            ...
            Pagination<Religion> items = _repo.GetItems(sortModel.SortedProperty, sortModel.SortedOrder, SearchText, pageIndex, pageSize);
        ...
        private readonly IReligion _repo;

        public ReligionController(IReligion repo)
        {
            _repo = repo;
        }
        ...
        [HttpPost]
        public IActionResult Create(Religion item)
        {
            bool myBool = false;
            string errMessage = "";
            try
        ...
        {
            Religion item = _repo.GetItem(id);
            TempData.Keep();
            return View(item);
        }
        ...
        [HttpPost]
        public IActionResult Edit(Religion item)
        {
            bool myBool = false;
            string errMessage = "";
            try
        ...
        [HttpPost]
        public IActionResult Delete(Religion item)
        {
            try
            {
