namespace TrikProjekt56.Controllers
{
    ...
    public class CorpseController : Controller
    {
        ...
        public IActionResult Index(string sortExpression = "", string SearchText = "", int pageIndex = 1, int pageSize = 5)
        {
            ...
            Pagination<Corpse> items = _repo.GetItems(sortModel.SortedProperty, sortModel.SortedOrder, SearchText, pageIndex, pageSize);
        ...
        private readonly ICorpse _repo;

        public CorpseController(ICorpse repo)
        {
            _repo = repo;
        }
        ...
        [HttpPost]
        public IActionResult Create(Corpse item)
        {
            bool myBool = false;
            string errMessage = "";
            try
        ...
        [HttpPost]
        public IActionResult Edit(Corpse item)
        {
            bool myBool = false;
            string errMessage = "";
            try
        ...
        [HttpPost]
        public IActionResult Delete(Corpse item)
        {
            try
            {
