namespace TrikProjekt56.Controllers
{
    ...
    public class GenderController : Controller
    {
        ...
        public IActionResult Index(string sortExpression = "", string SearchText = "", int pageIndex = 1, int pageSize = 5)
        {
            ...
            Pagination<Gender> items = _repo.GetItems(sortModel.SortedProperty, sortModel.SortedOrder, SearchText, pageIndex, pageSize);
        ...
        private readonly IGender _repo;

        public GenderController(IGender repo)
        {
            _repo = repo;
        }
